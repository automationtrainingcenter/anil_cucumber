...
public class EmployeeSteps {
	...
	public void admin_fills_employee_form(io.cucumber.datatable.DataTable dataTable) {
		/*
		 * single row and multiple columns -- List<String> multiple rows and multiple
		 * columns -- List<List<String>> single row or multiple rows and multiple
		 * columns with columns heading -- List<Map<String, String>>
		 */
...
//		System.out.println("selecting branch name "+row.get(3));
	...
	public void admin_can_see_an_empty_form() {
		Assert.assertTrue(employeeCreationpage.isFormEmpty());
	}
